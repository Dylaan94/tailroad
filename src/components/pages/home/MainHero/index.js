    ...
    <>
      <div className="mainHero relative flex h-[calc(100vh-96px)] w-full justify-center bg-white lg:justify-start ">
        <div className="flex h-full w-4/5 items-center justify-center lg:w-[60%] ">
          <div className="mainHero-container z-50 flex w-4/5 flex-col pb-16 lg:w-2/3">
            <h1
            ...
            <span>
              <button
                ...
                className="animate__animated animate__fadeInUp mt-10 rounded-full bg-primary-blue px-8 py-2 text-lg text-white"
              >
                <Link to="/contact">get a quote</Link>
              </button>
              <button
                style={{ animationDelay: "1.4s" }}
                className="animate__animated animate__fadeInUp ml-4 mt-10 rounded-full px-8 py-2 text-lg text-secondary-blue"
              >
      ...
      {/* Logo */}
      <img
        className="animate__animated animate__fadeIn absolute bottom-0 right-0 h-1/4 opacity-40 lg:h-1/2 lg:opacity-90 xl:h-[85%]"
        src={logoLarge}
        alt="logo"
      />
    </>
